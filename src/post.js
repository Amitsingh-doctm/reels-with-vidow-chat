...
import Video from './vidow';
import { database } from './firebase';
import Likes from './Like';
import AddComment  from './Addcomment';
import Comments from './Comments';
import Delatecomment  from './delatecomment';
const useStyles = makeStyles({
    ...
    return (
        <>
            ...
            {posts == null && load == true ? <CircularProgress className={classes.loader} color="secondary" /> :
                                            ...
                                            <div className='dcontainer'>
                                                ...
                                                <div className='info-part'>
                                                    ...
                                                    <div className='extra'>
                                                        ...
                                                        < Delatecomment userData ={userData} postData={post} />
